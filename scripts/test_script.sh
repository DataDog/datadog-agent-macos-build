...
# Run unit tests
inv -e test --rerun-fails=2 --python-runtimes $PYTHON_RUNTIMES --race --profile --save-result-json "test_output.json" --junit-tar "junit-tests_macos.tgz" $FAST_TESTS_FLAG $TEST_WASHER_FLAG
